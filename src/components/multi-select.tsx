                ...
                >
                    ...
                    <PopoverTrigger
                        ...
                        render={
                            <Button
                                ...
                                className={cn(
                                    "flex p-1 rounded-md border border-border bg-muted/50 min-h-10 h-auto items-center justify-between hover:bg-inherit [&_svg]:pointer-events-auto",
                    ...
                    >
                        ...
                        (Select All
                                ...
                                <CommandSeparator />
                                <CommandGroup className="sticky bottom-0 rounded-md z-10 bg-background/95 border-t border-border/80 backdrop-blur-sm">
                                    <div className="flex flex-col gap-2 p-1">
                                        <div className="grid grid-cols-2 gap-2">
                                            {selectedValues.length > 0 && (
                                                <CommandItem
                                                    onSelect={handleClear}
                                                    className="flex h-8 items-center justify-center gap-1 rounded-md border border-border/70 bg-muted/10 px-2 text-xs font-semibold text-foreground transition-colors hover:bg-muted/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/60"
                                                >
                                            ...
                                            <CommandItem
                                                ...
                                                className={cn(
                                                    "flex h-8 items-center justify-center gap-1 rounded-md border border-primary/20 bg-primary/10 px-2 text-xs font-semibold text-primary transition-colors hover:bg-primary/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 dark:bg-primary/20 dark:text-primary",
                                                    selectedValues.length === 0
                                                        ? "col-span-2"
                                                        : "col-span-1",
                                                )}
