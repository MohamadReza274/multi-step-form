...
const Navbar = () => {
    ...
    return (
        <div>
            <header className="bg-background shadow rounded-2xl">
                <div className="max-w-7xl mx-auto w-full px-4 py-4 sm:px-6">
                    ...
                    >
                        <a href="#">
                            <h2 className="text-xl font-bold">Multi Step</h2>
                        </a>
                        <div>
                        ...
                        <div className="lg:hidden">
                            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
                                <DropdownMenuTrigger
                                    className="rounded-full bg-background border border-border p-2 outline-none flex items-center justify-center cursor-pointer transition-colors">
                                ...
                                >
                                    {navigationData.map((item) => (
                                        <DropdownMenuItem key={item.title}>
                                            <a href={item.href}
                                               className="w-full cursor-pointer text-sm font-medium">{item.title}</a>
                                        </DropdownMenuItem>
                                    ))}
                                </DropdownMenuContent>
                            </DropdownMenu>
